...
const memoryCards = [
  ...
  function startGame() {
    ...
    if (gameMode === "easy") {
      cards = memoryCards.slice(0, 4);
      cardList.classList.add("easy");
    } else if (gameMode === "medium") {
      cardList.classList.add("medium");
      cards = memoryCards.slice(0, 8);
    } else {
  ...
  function resetEverything() {
    ...
    if (gameMode === "easy") cardList.classList.remove("easy");
    else if (gameMode === "medium") cardList.classList.remove("medium");
    else cardList.classList.remove("hard");
    startModal.style.display = "block";
  }
  ...
  function updateReflection(card, degree) {
    card.style.background = `linear-gradient(${degree}deg, rgba(255 130 71) 0%,rgba(238 121 66) `;
